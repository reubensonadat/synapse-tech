            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <Link href="/studio/services/website-development" className="hover:text-primary transition-colors">
                                    Website Development
                                </Link>
                            </li>
                            <li>
                                <Link href="/studio/services/content-creation" className="hover:text-primary transition-colors">
                                    Content Creation
                                </Link>
                            </li>
                            <li>
                                <Link href="/studio/services/graphic-design" className="hover:text-primary transition-colors">
                                    Graphic Design
                                </Link>
                            </li>
                            <li>
                                <Link href="/studio/services/website-maintenance" className="hover:text-primary transition-colors">
                                    Website Maintenance
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <Link href="/about?source=studio" className="hover:text-primary transition-colors">
                                    About Us
                                </Link>
                            </li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li className="pt-4">
                                <Link
                                    href="/studio/work"
                                    className="inline-block px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all text-sm font-bold"
                                >
                ...
                <div className="pt-8 border-t border-border dark:border-white/10">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
                        ...
                        <Link href="/systems" className="text-xs hover:text-systems transition-colors">
