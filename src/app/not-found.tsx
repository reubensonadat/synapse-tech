...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-white dark:bg-background text-black dark:text-white flex flex-col selection:bg-primary selection:text-white transition-colors duration-200">
            <Navbar />
            ...
            <main className="flex-grow min-h-[80vh] flex items-center justify-center px-6 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center max-w-2xl mx-auto">
                    ...
                    <h1 className="text-[150px] md:text-[200px] font-bold font-heading leading-none text-transparent bg-clip-text bg-gradient-to-b from-black to-background-subtle dark:from-white dark:to-white/10 select-none">
                        404
                    </h1>

                    <p className="text-xl md:text-2xl text-muted-foreground dark:text-muted-foreground mb-8 max-w-lg mx-auto">
