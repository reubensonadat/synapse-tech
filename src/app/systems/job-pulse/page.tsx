                    ...
                    <div className="relative z-10 max-w-5xl mx-auto px-6">
                        <motion.div initial="hidden" animate="visible" variants={stagger}>
                            ...
                            <motion.h1 className="text-4xl md:text-6xl font-bold font-heading tracking-tight mb-4" variants={fadeInUp}>
                                <span className="text-systems">Job Pulse</span>
                            </motion.h1>
                            <motion.p className="text-xl md:text-2xl text-muted-foreground dark:text-muted-foreground mb-6" variants={fadeInUp}>National Career Engine</motion.p>
                ...
                <section className="py-20 bg-white dark:bg-background transition-colors duration-200">
                    <div className="max-w-4xl mx-auto px-6">
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
                            ...
                            <motion.h2 className="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-6" variants={fadeInUp}>Broken Job Markets</motion.h2>
                ...
                <section className="py-20 bg-background-subtle dark:bg-background/50 transition-colors duration-200">
                    <div className="max-w-4xl mx-auto px-6">
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
                            ...
                            <motion.h2 className="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-6" variants={fadeInUp}>AI-Powered Career Matching</motion.h2>
                            <motion.p className="text-muted-foreground dark:text-muted-foreground leading-relaxed text-lg" variants={fadeInUp}>
                    ...
                    <div className="max-w-3xl mx-auto px-6 text-center">
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
                            ...
                            <motion.div variants={fadeInUp}>
                                <Link href="/studio/contact?source=job-pulse" className="inline-flex items-center gap-2 px-8 py-4 bg-systems text-white font-bold rounded-xl hover:bg-systems/90 transition-all shadow-lg shadow-systems/25 group">
