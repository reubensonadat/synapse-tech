...
import { SwatchIcon, ChevronLeftIcon, ChevronRightIcon } from '@heroicons/react/24/outline';
                ...
                <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
                    ...
                    >
                        <motion.div variants={scaleIn}>
                            <SwatchIcon className="w-20 h-20 text-primary mx-auto mb-8" />
                        </motion.div>
                        ...
                        <div className="relative h-96 bg-gradient-to-br from-background-subtle to-background-subtle dark:from-background-subtle dark:to-background-subtle rounded-3xl overflow-hidden">
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-center">
                                    <SwatchIcon className="w-32 h-32 text-primary/30 mx-auto mb-4" />
